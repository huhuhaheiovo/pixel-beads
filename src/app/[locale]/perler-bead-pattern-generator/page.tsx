  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#18181B]">
          Loading...
        </span>
      </div>
    </div>
...
export default function GeneratorPage () {
  return (
    <main className="min-h-screen bg-white" role="main" aria-label="Perler bead pattern generator">
