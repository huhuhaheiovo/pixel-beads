  ...
  return (
    <div className='flex flex-col items-center justify-center p-12 bg-white/50 backdrop-blur-sm border border-white shadow-2xl rounded-[32px] text-center animate-in fade-in zoom-in slide-in-from-bottom-8 duration-700 ease-out max-w-lg mx-auto'>
      ...
      <div className='relative'>
        <label
          htmlFor='upload'
          className='relative overflow-hidden inline-flex items-center gap-3 px-10 py-5 bg-[#32B8A6] text-white text-[12px] font-black uppercase tracking-[0.2em] cursor-pointer shadow-[0_20px_40px_rgba(50,184,166,0.3)] hover:shadow-[0_25px_50px_rgba(50,184,166,0.4)] transform transition-all duration-500 hover:scale-110 hover:rotate-3 hover:skew-x-12 active:scale-95 rounded-2xl'
        >
