                    ...
                    <div className='hidden md:flex items-center gap-4'>
                        ...
                        <div className='flex items-center border border-[#F7F1E1]/20 rounded-full px-2 py-1 gap-1 bg-white/5'>
                            ...
                            <Link
                                href={pathname}
                                locale='ja'
                                className={`px-2 py-1 text-[8px] font-black uppercase rounded-full transition-all ${locale === 'ja' ? 'bg-[#32B8A6] text-[#3E2A1E] shadow-sm' : 'text-[#F7F1E1]/70 hover:bg-white/10 hover:text-[#F7F1E1]'}`}
                            >
                                JA
                            </Link>
                        </div>
